...
const DIC = {
  en: {
    ...
    'lp.h1':'Know the edge before the whistle.',
    'lp.sub':'Verifiable stats, real market signals and an honest win probability for every match. No hype, just the numbers that matter.',
    'lp.cta':'Get started','lp.cta2':'See plans','lp.leagues':'leagues','lp.public':'public data','lp.from':'to start',
    'lp.today':'Today','lp.conf':'Medium confidence, home edge',
    'lp.whyt':'Why Handicapper',
  ...
  es: {
    ...
    'lp.h1':'Conoce la ventaja antes del pitazo.',
    'lp.sub':'Estadísticas verificables, señales reales del mercado y una probabilidad honesta para cada partido. Sin humo, solo los números que importan.',
    'lp.cta':'Comenzar','lp.cta2':'Ver planes','lp.leagues':'ligas','lp.public':'datos públicos','lp.from':'para empezar',
    'lp.today':'Hoy','lp.conf':'Confianza media, ventaja local',
    'lp.whyt':'Por qué Handicapper',
