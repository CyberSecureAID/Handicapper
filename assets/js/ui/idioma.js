...
const DIC = {
  en: {
    ...
    'lp.sub':'Verifiable stats, real market signals and a clear win probability for every match, with the confidence level behind each number.',
  ...
  es: {
    ...
    'lp.sub':'Estadísticas verificables, señales reales del mercado y una probabilidad clara para cada partido, con el nivel de confianza detrás de cada número.',
